...
public static class DispatcherExtensions
{
    ...
    public static SwitchToUiAwaitable SwitchToDispatcherThread(this Dispatcher dispatcher) => new SwitchToUiAwaitable(dispatcher);
    ...
    public readonly struct SwitchToUiAwaitable : INotifyCompletion
    {
        ...
        public void OnCompleted(Action continuation) => _ = _dispatcher.BeginInvoke(continuation);
    }
}
