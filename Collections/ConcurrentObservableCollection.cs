...
public class ConcurrentObservableCollection<T> : IList<T>, IReadOnlyList<T>, IList
{
    ...
    private static Dispatcher GetCurrentDispatcher() => Application.Current?.Dispatcher ?? Dispatcher.CurrentDispatcher;
    ...
    public void StableSort() => StableSort(comparer: null);
