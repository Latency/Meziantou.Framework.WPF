...
public static partial class WindowUtilities
{
    ...
    public static bool GetCloseOnEscapeKeyDown(DependencyObject d) => (bool)d.GetValue(CloseOnEscapeProperty);

    public static void SetCloseOnEscapeKeyDown(DependencyObject d, bool value) => d.SetValue(CloseOnEscapeProperty, value);
